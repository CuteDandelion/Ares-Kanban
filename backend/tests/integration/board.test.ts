...
describe('Board API - Integration Tests (Real Database)', () => {
  ...
  describe('GET /api/board/columns', () => {
    ...
    beforeEach(async () => {
      ...
      testBoard = createTestBoard({ user_id: testUser.id })
      testColumns = createTestColumns(3, testBoard.id)
    ...
    test('should return all columns ordered by position', async () => {
      ...
      assertSortedBy(response.body, 'position', 'asc')
  ...
  describe('GET /api/board/columns/:id', () => {
    ...
    beforeEach(async () => {
      testUser = createTestUser()
      testBoard = createTestBoard({ user_id: testUser.id })
      testColumn = createTestColumn({ board_id: testBoard.id })
  ...
  describe('PUT /api/board/columns/:id', () => {
    ...
    beforeEach(async () => {
      testUser = createTestUser()
      testBoard = createTestBoard({ user_id: testUser.id })
      testColumn = createTestColumn({ board_id: testBoard.id, name: 'Original Name' })
  ...
  describe('DELETE /api/board/columns/:id', () => {
    ...
    beforeEach(async () => {
      ...
      testBoard = createTestBoard({ user_id: testUser.id })
      testColumn = createTestColumn({ board_id: testBoard.id })
      testCards = createTestCards(2, testColumn.id)
  ...
  describe('GET /api/board/cards', () => {
    ...
    beforeEach(async () => {
      ...
      testBoard = createTestBoard({ user_id: testUser.id })
      testColumn = createTestColumn({ board_id: testBoard.id })
      testCards = createTestCards(3, testColumn.id)
    ...
    test('should return all cards ordered by created_at DESC', async () => {
      ...
      expect(response.body).toHaveLength(3)
      assertSortedBy(response.body, 'created_at', 'desc')
    })
  ...
  describe('PUT /api/board/cards/:id', () => {
    ...
    test('should move card to different column', async () => {
      const secondColumn = createTestColumn({ board_id: testBoard.id })
