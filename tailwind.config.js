...
module.exports = {
  ...
  theme: {
      ...
      boxShadow: {
        ...
        'glow-amber': '0 0 12px rgba(251, 191, 36, 0.5)',
        ...
        'glow-purple': '0 0 12px rgba(168, 85, 247, 0.5)',
        'glow-violet': '0 0 12px rgba(139, 92, 246, 0.5)',
        'glow-slate': '0 0 12px rgba(100, 116, 139, 0.5)',
        'cli': '0 -4px 20px rgba(0, 0, 0, 0.4)',
